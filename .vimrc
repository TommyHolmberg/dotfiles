...
"Snippets settings
"let g:UltiSnipsSnippetDirectories=[$HOME."/.vim/plugged/vim-snippets/mysnippets"]
...
function! CStart()
  ...
  let height = 12
  exec "normal \<C-w>s\<C-j>" . height . "\<C-w>_"
  :term
  "Open nerdtree and shrink width x steps
  :NERDTreeToggle
  let shrink = 8
  exec "normal " . shrink . "\<C-w>\<\<C-l>"
  "Open all folds
  exe "normal zR"
endfunction

au VimEnter * call CStart()
